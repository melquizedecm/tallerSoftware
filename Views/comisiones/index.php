...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            '<td><input type="text" class="form-control" name="inputPorcentaje" id="inputPorcentaje"></td>' +
            '<td><input type="text" class="form-control" name="inputFecha"      id="inputFecha"></td>' +
                            '<td>' + actions + '</td>' +
                            '</tr>';
                    $("table").prepend(row);
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>Comisiones</h2></div>
                        <div class="col-sm-4">
